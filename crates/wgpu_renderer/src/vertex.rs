...
impl Vertex {
    ...
    /// CCW order. indices: 0,1,2 0,2,3
    #[inline(always)]
    pub const fn new_gradient_rect(
        min: [f32; 2],
        max: [f32; 2],
        ...
        [
            ...
            Self {
                position: min,
                color: color.get_point(Point2D::new(min)).premultiply().components,
                kind: VertexKind::Color as u32,
                texture: 0,
                tex_coords: [0., 0.],
            },
            ...
            Self {
                position: max,
                color: color.get_point(Point2D::new(max)).premultiply().components,
                kind: VertexKind::Color as u32,
                texture: 0,
                tex_coords: [0., 0.],
            },
